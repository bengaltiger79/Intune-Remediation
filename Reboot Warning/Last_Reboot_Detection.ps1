...
# By default it's 14 days, meaning is the device has not rebooted since 5 days or more a warning will be displayed
$Reboot_Delay = 14
...
If($Last_boot -eq $null)
	{
		# If event log with ID 27 can not be found we check last reboot time using WMI
